...
public class CouldBeChild extends TestCSV_Factory {
    ...
    public CouldBeChild(final List<Person> persons) {
    ...
    private void generateArray(final List<Person> persons) {
        ...
        for (int i = 0; i < persons.size(); i++) {
            ...
            for (Person p : persons) {
                ...
                if (aspirantIsOlderThanPerson.test(aspirant, person)) {
                    addArrayToList(true, aspirant + " is older than " + person);
                }
                ...
                if (hasTwoParents.test(aspirant) && !aspirantIsParentOfPerson.test(person, aspirant)) {
                    addArrayToList(true, aspirant + " has already two other parents : " + aspirant.getParents());
                }
    ...
    private void addArrayToList(boolean boo, String additionalMessage) {
        ...
        String LIST_NAME = "children list";
