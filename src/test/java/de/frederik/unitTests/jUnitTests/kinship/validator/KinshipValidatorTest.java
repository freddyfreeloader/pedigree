...
class KinshipValidatorTest {
    ...
    @ParameterizedTest(name = "CHILD: {index} Add {0} as child of {1} should create error code: {2}")
    ...
    @ParameterizedTest(name = "PARENT: {index} Add {0} as parent of {1} should create error code: {2}")
    ...
    @ParameterizedTest(name = "SIBLING: {index} Add {0} as sibling of {1} should create error code: {2}")
    ...
    @ParameterizedTest(name = "SPOUSE: {index} Add {0} as spouse of {1} should create error code: {2}")
